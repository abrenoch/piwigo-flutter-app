...
class SortedViewPage extends StatefulWidget {
  SortedViewPage({Key key, this.isAdmin, this.nbImages, this.title, this.sorting}) : super(key: key);
  final bool isAdmin;
  final int nbImages;
  final SortModel sorting;
  final String title;

  @override
  _SortedViewPageState createState() => _SortedViewPageState();
}
class _SortedViewPageState extends State<SortedViewPage> with SingleTickerProviderStateMixin {
        ...
        NestedScrollView(
          ...
          body: ContentGrid(
              ...
              loadMoreImages: (int page) {
                print('Loading page $page of sorted images: ${_sorting.sortOrder}');
                return fetchImages(page, sorting: _sorting);
              },
  ...
  Widget createAppBar() {
    ...
    return SliverAppBar(
      ...
      Text(widget.title != null ? widget.title : _sorting.sortTitle),
      actions: [
