...
import 'package:piwigo_ng/views/components/sort_menu_button.dart';


class CollectionsViewPage extends StatefulWidget {
  CollectionsViewPage({Key key, this.isAdmin, this.nbImages, this.collection, this.title}) : super(key: key);
  final bool isAdmin;
  final int nbImages;
  ...
  @override
  _CollectionsViewPageState createState() => _CollectionsViewPageState();
}
class _CollectionsViewPageState extends State<CollectionsViewPage> with SingleTickerProviderStateMixin {
        ...
        NestedScrollView(
          ...
          body: ContentGrid(
              ...
              loadMoreImages: (int page) {
                print('Loading page $page of collection ${widget.collection}');
                return fetchCollectionImages(widget.collection, page);
              },
