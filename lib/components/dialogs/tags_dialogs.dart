...
// import '../../views/components/dialogs/piwigo_dialog.dart';
...
//         ],
//       ),
//       body: FutureBuilder<ApiResponse<List<TagModel>>>(
//         future: getTags(),
...
//         TagModel(id: 0, name: appStrings.none),
//         isEnd: true,
//       ) : ListView.builder(
//         shrinkWrap: true,
...
//               child: Text(appStrings.tagsHeader_selected,
...
//               alignment: Alignment.topLeft,
//               padding: EdgeInsets.all(5),
//               child: Text(appStrings.tagsHeader_notSelected,
//                   style: Theme.of(context).textTheme.headline5
//               ),
//             ),
...
//           children: <Widget>[
//             Center(
//               child: Text(appStrings.tagsAdd_message,
...
//                 CircularProgressIndicator(
//                     valueColor: AlwaysStoppedAnimation<Color>(Colors.white)
//                 ) : Text(appStrings.alertAddButton,
//                     style: TextStyle(fontSize: 16, color: Colors.white)
//                 ),
//                 style: _isNameEmpty() ?
                ...
                child: Ink(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Align(
                        alignment: Alignment.topLeft,
                        child: Text(appStrings.tags,
                            style: Theme.of(context).textTheme.headline1
                        ),
                      ),
                      Align(
                        alignment: Alignment.topLeft,
                        child: Text(appStrings.tagsTitle_selectOne,
                            style: Theme.of(context).textTheme.headline5
                        ),
                      ),
                      SizedBox(height: 10),
                      ...
                      FutureBuilder<List<dynamic>>(
                          ...
                          builder: (BuildContext context, AsyncSnapshot tagsSnapshot) {
                            ...
                            if(tagsSnapshot.hasData){
                              ...
                              //   ); //appStrings.categoryMainEmtpy
                              // }
                              // var tags = tagsSnapshot.data['result']['tags'];
                              // tagsSnapshot.data.removeWhere((tag) => (
                              //     tag.counter < 1
                              // ));
                                  ...
                                  children: <Widget>[
                                    ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        var tag = tagsSnapshot.data[index];
                                        var borderRadius = BorderRadius.circular(0);
                                        var radius = Radius.circular(10);

                                        if(index == tagsSnapshot.data.length - 1) {
                                          borderRadius = BorderRadius.only(
                                            bottomLeft: radius,
                                            bottomRight: radius,
                                          );
                                        ...
                                        return ListTile(
                                            ...
                                            title: Text(
                                                tag.name + ' (${ appStrings.imageCount(tag.counter) })',
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                          appStrings.tagCount(tagsSnapshot.data.length),
